...
//MODIFIED SLIGHTLY FOR USE IN THIS PROJECT
...
#if !defined(__gl_h_) && !defined(__glcorearb_h_) //REMOVED ERROR STATEMENT FROM THE ORIGINAL
#endif

#include <stdlib.h> /* malloc(), calloc(), free() */
#include <string.h> /* memset(), memcpy(), strlen() */
#include <stdint.h> /* uint8_t, uint16_t, uint32_t, uint64_t */
#include <GL/glew.h> //ADDED GLEW IMPORT FROM THE ORIGINAL
